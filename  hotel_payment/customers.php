...
<?php if (isset($_GET['error']) && $_GET['error'] == 'has_bookings'): ?>
    <div class="alert alert-danger">❌ Cannot delete customer with existing bookings!</div>
<?php endif; ?>
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tbody>
                            <?php if ($customers->num_rows > 0): ?>
                                <?php while($row = $customers->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="customer-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="customer-delete.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this customer?')">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" style="text-align:center; padding:30px; color:#999;">No customers found</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>

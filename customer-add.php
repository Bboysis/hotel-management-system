...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO customers (full_name, email, phone, address, id_number, nationality) 
            VALUES ('$full_name', '$email', '$phone', '$address', '$id_number', '$nationality')";
...
<head>
    ...
    <title>
    Add Customer - Hotel Management</title>
